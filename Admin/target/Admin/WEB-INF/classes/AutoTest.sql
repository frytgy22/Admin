...
ALTER TABLE `GroupsStudents`
  ADD CONSTRAINT `fk1_groups_students` FOREIGN KEY (`groupID`) REFERENCES `Groups` (`groupID`),
  ADD CONSTRAINT `fk2_groups_students` FOREIGN KEY (`studentID`) REFERENCES `Students` (`studentID`);

--
-- Constraints for table `GroupsSubjects`
--
ALTER TABLE `GroupsSubjects`
  ADD CONSTRAINT `fk1_groups_subjects` FOREIGN KEY (`groupID`) REFERENCES `Groups` (`groupID`),
  ADD CONSTRAINT `fk2_groups_subjects` FOREIGN KEY (`subjectID`) REFERENCES `Subjects` (`subjectID`);

--
-- Constraints for table `GroupsTeachers`
--
ALTER TABLE `GroupsTeachers`
  ADD CONSTRAINT `fk1_groups_teachers` FOREIGN KEY (`groupID`) REFERENCES `Groups` (`groupID`),
  ADD CONSTRAINT `fk2_groups_teachers` FOREIGN KEY (`teacherID`) REFERENCES `Teachers` (`teacherID`);

--
-- Constraints for table `RolesAdmins`
--
ALTER TABLE `RolesAdmins`
  ADD CONSTRAINT `fk1_roles_admins` FOREIGN KEY (`roleID`) REFERENCES `Roles` (`roleID`),
  ADD CONSTRAINT `fk2_roles_admins` FOREIGN KEY (`adminID`) REFERENCES `Admins` (`adminID`);

--
-- Constraints for table `RolesTeachers`
--
ALTER TABLE `RolesTeachers`
  ADD CONSTRAINT `fk1_roles_teachers` FOREIGN KEY (`roleID`) REFERENCES `Roles` (`roleID`),
  ADD CONSTRAINT `fk2_roles_teachers` FOREIGN KEY (`teacherID`) REFERENCES `Teachers` (`teacherID`);

--
-- Constraints for table `Students`
--
ALTER TABLE `Students`
  ADD CONSTRAINT `fk_students_roles` FOREIGN KEY (`roleID`) REFERENCES `Roles` (`roleID`);
COMMIT;
